...
| Kernel | 14 | CIS 1.6 / ANSSI R14 | ASLR, ptrace, syncookies, BPF non privilégié, masquage des pointeurs kernel (modes renforcés acceptés), protections hardlink/symlink/FIFO/fichiers de `/tmp` |
