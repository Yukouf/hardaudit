...
Guide technique : commandes de vérification pour chaque constat produit par
HardAudit (valeurs `sysctl`, permissions, configuration effective SSH, etc.).
Ce document est destiné aux auditeurs qui veulent **reproduire et confirmer**
chaque anomalie avant remédiation.

> Contenu extrait du README principal pour le garder lisible.
